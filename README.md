...
On a MacOS device that has the retail version of Starcraft II installed in the default applications folder, use `"/Applications/StarCraft II/Support/SC2Switcher.app/Contents/MacOS/SC2Switcher" -listen 127.0.0.1 -port 5000 -displayMode 0 -launch`  
